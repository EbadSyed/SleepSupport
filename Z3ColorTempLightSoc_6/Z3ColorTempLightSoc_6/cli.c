...
static EmberCommandEntry emberCommandTablePluginRelativeHumidityMeasurementServerCommands[] = {
...
static EmberCommandEntry emberCommandTablePluginCommands[] = {
  ...
  emberCommandEntrySubMenu("relative-humidity-measurement-server", emberCommandTablePluginRelativeHumidityMeasurementServerCommands, ""),
